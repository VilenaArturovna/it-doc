...
export const YaMap = () => {
  return (<Root>
    ...
    <Description
      href="https://yandex.ru/maps/66/omsk/category/computer_repairs_and_services/184105768/?utm_medium=mapframe&utm_source=maps"
    >
      Компьютерный ремонт и услуги в Омске
    </Description>
    <Description1
      href="https://yandex.ru/maps/66/omsk/category/office_equipment_service_and_repair/184105560/?utm_medium=mapframe&utm_source=maps"
    >
