    ...
    <Root>
      <Container>
        ...
        <Contacts id={'contacts'}>
          ...
          <ContactsText>
            Телефон: <ContactsRef href={'tel:+7381237-85-03'}>+7 (3812) 37-85-03</ContactsRef>
          </ContactsText>
          <ContactsText>
            <ContactsRef href="mailto:info@itdoc55.ru">info@itdoc55.ru</ContactsRef>
          </ContactsText>
          <ContactsText>
            Понедельник – Пятница 08:00–18:00,
            <br /> без перерыва на обед, <br />
